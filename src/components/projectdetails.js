...
function Projectdetails({ openDetail, project }) {
  ...
  return (
    <div className="rounded-xl border border-gray-300 shadow-lg py-6 bg-white w-full max-w-lg sm:max-w-md md:max-w-2xl mx-4 overflow-auto md:overflow-hidden">
      ...
      <div className="text-gray-500 text-sm px-6">{project.company}</div>
      ...
      <div className="min-w-[400px]">
        {details.overview && <Projectdetailsoverview project={project} />}
