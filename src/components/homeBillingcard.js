...
function HomeBillingcard({ type, price, features, buttoncolor, popular }) {
  return (
    <Card
      className={`bg-white font-sans w-76  min-h-[430px] shadow-xl relative mt-4 ${
    ...
    >
      ...
      <CardContent>
        <div className="text-center mb-8 mt-2">
          <h2 className="text-2xl text-gray-900 font-bold">{type}</h2>
          <h2 className="text-4xl my-1 text-gray-900 font-bold">${price}</h2>
          <h5 className="text-gray-600 mt-1">per month</h5>
        </div>
