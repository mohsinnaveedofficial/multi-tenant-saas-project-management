      ...
      <div>
        ...
        <div className="flex m-4 flex-col md:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex justify-end lg:justify-start w-full lg:w-auto">
            <div className="rounded-lg bg-gray-100  dark:bg-gray-700 flex h-11 gap-2 items-center px-2">
              <button
            ...
            {tableview && (
              <div className="  rounded-lg overflow-hidden m-6 shadow-sm">
                <table className=" w-full rounded-lg border overflow-hidden dark:border-gray-700 border-gray-200 border-separate dark:bg-gray-800 bg-gray-100 m-0 mt-0 border-spacing-y-[3px]  border-spacing-x-0 ">
                  <thead className="bg-gray-50 text-gray-500 dark:text-gray-200 dark:bg-gray-800 uppercase text-xs text-left font-semibold">
                    <tr>
                      ...
                      <th className="font-semibold py-3 px-6 text-center">
                        ACTIONS
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-700 bg-white  dark:bg-gray-700">
